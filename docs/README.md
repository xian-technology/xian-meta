...
- `XIAN_VM_LANGUAGE_EXPANSION_ROADMAP.md`: ranked roadmap for growing the contract language safely around Xian-owned VM semantics instead of inheriting CPython's execution boundary
